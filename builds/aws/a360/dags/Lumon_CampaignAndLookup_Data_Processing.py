...
@dag(
    dag_id="Lumon_CampaignAndLookup_Data_Processing_",
...
def pipeline_function():
    ...
    if current_env == "Prod":
        json_config_path = default_args["config_path"] + \
            "/Lumon_CampaignAndLookup_Data_Processing__prod.json"
    else:
        json_config_path = default_args["config_path"] + \
            "/Lumon_CampaignAndLookup_Data_Processing_.json"
    ...
    def dps_mcd_hist_bkp(**kwargs):
        ...
        s3_key = f"{cfg['s3_key_athena_glue']}{cfg['dp_config']['']['athena_partitioned_table']}/"
    ...
    def business_to_internal_s3_file_transfer(**kwargs):
        ...
        feed_types = ['Campaign Data', 'Lookup Data']
